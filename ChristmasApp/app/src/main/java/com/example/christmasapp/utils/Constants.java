...
public abstract class Constants {
    ...
    public static final String JSON_POI_API_URL = "https://api.jsonbin.io/b/5ff65b6609f7c73f1b6e914d/17";
    public static final String POI_OBJECT_BUNDLE = "POI OBJECT BUNDLE";
    public static final String NOTIFICATIONS_KEY = "NOTIFICATIONS";
    public static final String MQTT_SUBSCRIBED = "MQTT SUBSCRIBED";
}
